...
/**
 * CounterPorudzbinaSearch represents the model behind the search form of `app\models\CounterPorudzbina`.
 */
class CounterPorudzbinaSearch extends CounterPorudzbina
{
    /**
     * {@inheritdoc}
     */
